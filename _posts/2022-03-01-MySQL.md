...
1. 数值类型：
   ...
   <img src="photo/image-20210912000945238.png" alt="image-20210912000945238" style="zoom:67%;" />

2. 文本类型（字符串类型）：

   <img src="photo/image-20210912001116614.png" alt="image-20210912001116614" style="zoom:67%;" />

3. 二进制数据类型

   ![image-20210912001330626](photo/image-20210912001330626-16313768117614.png)

4. 日期类型

   <img src="photo/image-20210912001753675.png" alt="image-20210912001753675" style="zoom:67%;" />
